...
(def-doom-theme doom-gruvbox
  ...
  ((button :foreground cyan :underline t :weight 'bold)
   ...
   ; (org-levels)
   (org-level-1 :foreground red :weight)
   (org-level-2 :foreground cyan :weight)
   (org-level-3 :foreground green :weight)
   (org-level-4 :foreground orange :weight)
   (org-level-5 :foreground yellow :weight)
   (org-level-6 :foreground red :weight)
   (org-level-7 :foreground dark-green :weight)
   (org-level-8 :foreground dark-yellow :weight)
   ;;;; rainbow-delimiters
