...
static unsigned int gappov    = 40;       /* vert outer gap between windows and screen edge */
static int swallowfloating    = 0;        /* 1 means swallow floating windows by default */
static int smartgaps          = 0;        /* 1 means no outer gap when there is only one window */
static int showbar            = 1;        /* 0 means no bar */
static int topbar             = 0;        /* 0 means bottom bar */
static char *fonts[]          = { "JetbrainsMonoNL NFP:size=10", "Font Awesome 6 Free Solid:size=10"  };
static char normbgcolor[]           = "#282828";
static char normbordercolor[]       = "#444444";
static char normfgcolor[]           = "#eeeeee";
static char selfgcolor[]            = "#fbf1c7";
static char selbordercolor[]        = "#97981a";
...
static const Rule rules[] = {
  ...
  { "feh",      NULL,        NULL,         0,           1,           0,          0,         -1 },
	{ TERMCLASS,  "ranger",    NULL,       	 0,    				1,           1,          0,         -1 },
};
...
static const Key keys[] = {
  ...
  { MODKEY,             XK_Print,      spawn,          SHCMD("~/.screenshot -z") },
	...
	{ MODKEY,		  XK_F1,         spawn,                  {.v = (const char*[]){ TERMINAL, "-e", "nvim", "/home/k/notes/index.norg", NULL } } },
	{ MODKEY,			XK_F2,         spawn,                  SHCMD("qutebrowser wikipedia.com") },
